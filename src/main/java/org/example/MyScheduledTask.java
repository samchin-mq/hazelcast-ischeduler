...
public class MyScheduledTask implements Runnable, Serializable {
    ...
    public MyScheduledTask(String schedulerInstanceId) {
    ...
    public void run() {
        ...
        System.out.println("Task 'my-periodic-task-1' executed successfully by " + schedulerInstanceId + " at " + formattedTime);
    }
}
